...
@onready var state_line: Label = $VBox/StateLine
@onready var list: ItemList = $VBox/PlayersList

@onready var admin_pass: LineEdit = $VBox/AdminBox/AdminPass
@onready var admin_status: Label = $VBox/AdminBox/AdminStatus
