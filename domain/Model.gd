...
class Player:
	...
	var sound_tap: String = ""   # identifier (filename/uri-key)
	var sound_warn: String = ""  # optional
...
class GameState:
	...
	var players: Dictionary = {}         # name -> Player
	var order: PackedStringArray = []
	var order_dir: int = Const.OrderDir.CW
	var bank_ms: Dictionary = {}         # name -> int
	...
	# warn tracking (per current turn)
